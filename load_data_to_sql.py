...
tables = ["real_acct", "building_res", "fixtures", "extra_features_detail1", "parcels"]
for table in tables:
...
def import_data(file_name, table_name, delimiter="\t"):
    ...
    if os.path.exists(file_path):
        ...
        try:
            ...
            df = pd.read_csv(
                file_path, delimiter=delimiter, dtype=str, encoding="ISO-8859-1"
            )
...
import_parcels()  # Import GIS parcel data
